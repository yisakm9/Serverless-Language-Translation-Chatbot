...
# Define the 'sourceText' slot as its own resource
...
# Define the 'targetLanguage' slot as its own resource
...
# CHANGED: Corrected resource name from "aws_lexv2models_bot_alias" to "aws_lex_bot_alias"
